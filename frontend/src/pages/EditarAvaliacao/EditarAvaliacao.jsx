    ...
    useEffect(() => {
        ...
        async function carregarDados() {
            ...
            try {
                ...
                const [responseAvaliacao, responseAlunos] =
                    await Promise.all([
                        axios.get(
                ...
                const avaliacao = responseAvaliacao.data;

                setAlunos(responseAlunos.data);

                setUsuarioId(avaliacao.usuario_id);
                setPeso(avaliacao.peso);
                setAltura(avaliacao.altura);
                setDataAvaliacao(avaliacao.data_avaliacao);
    ...
    return (
        ...
        <Layout>
            ...
            <div>
                ...
                <form
                    onSubmit={handleAtualizarAvaliacao}
                ...
                >
                    ...
                    <div className="bg-purple-50 border border-purple-100 rounded-xl p-4">
                        ...
                        <p className="text-sm text-purple-800">
                            Ao salvar, o IMC será recalculado automaticamente.
                        </p>
